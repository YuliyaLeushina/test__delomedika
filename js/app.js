(() => {
      ...
      if (l.length)
        return (
          l.forEach((t) => {
            ...
            i.push({ itemsArray: o, matchMedia: n });
          }),
          i
        );
    }
  ...
  e.select = new (class {
    ...
    getOption(e, t) {
      ...
      return (
        (o += a
          ? `<a ${n} ${l} href="${a}" data-value="${e.value}" class="${this.selectClasses.classSelectOption}${i}${s}">`
        ...
        function o(e) {
          ...
          if (t.closest("[data-spoller]")) {
            const s = t.closest("[data-spoller]"),
              ...
              n = i.dataset.spollersSpeed
                ? parseInt(i.dataset.spollersSpeed)
                : 500;
            i.querySelectorAll("._slide").length ||
              (a && !s.classList.contains("_spoller-active") && c(i),
              s.classList.toggle("_spoller-active"),
              l(s.nextElementSibling, n)),
              e.preventDefault();
          }
        }
        function c(e) {
